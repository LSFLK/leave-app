...
type GetEmployeeResponse record {
...
type GetEmployeesResponse record {
    *graphql:GenericResponseWithErrors;
    # Employees data
    record {
...
public type EmployeeEntity record {
    # Employee ID
    string employeeId;
    # First name
    string? firstName;
...
type GetOrgDataResponse record {|
    *graphql:GenericResponseWithErrors;
    # Org Data
    record {
...
public type OrgDataEntity record {|
    # Number of organizational levels
    int orgLevelCount;
    # Employee countries
    string[] countries;
    # Organizational structure
    types:OrgItem[] orgStructure;
...
#
type CreateLeaveResponse record {|
    *graphql:GenericResponseWithErrors;
...
type ValidateLeaveResponse record {|
    # Error details
...
type CancelLeaveResponse record {|
    *graphql:GenericResponseWithErrors;
...
public type HolidayEntity record {|
    # Holiday ID
    string id;
    # Holiday title
    string title;
...
type GetHolidaysResponse record {|
    *graphql:GenericResponseWithErrors;
    # Holidays response
    record {
