...
// Errors
public const GENERIC_ERROR = "Something went wrong while proccesing your request, please try again, or if the problem persists contact DT Team";
...
public const ERR_MSG_ORAGNIZATION_DATA_RETRIEVAL_FAILED = "Error occurred while retrieving organization data";
...
public type ValidationErrorMessage ERR_MSG_LEAVE_SHOULD_BE_AT_LEAST_ONE_WEEKDAY|ERR_MSG_LEAVE_OVERLAPS_WITH_EXISTING_LEAVE|ERR_MSG_LEAVE_SHOULD_BE_AT_LEAST_ONE_WORKING_DAY;
