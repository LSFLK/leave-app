...
public isolated function getAllEmailRecipientsForUser(string email, string[] userAddedRecipients) returns string[] {
    ...
    return recipientMap.keys();
}

public isolated function getPrivateRecipientsForUser(string email, string[] userAddedRecipients) returns string[] {
    map<true> recipientMap = {
        [email] : true
    };
